...
namespace GHGHGym.Infrastructure.Migrations
{
    ...
    [Migration("20221113173130_AddedGenderToUser")]
            ...
            modelBuilder.Entity("GHGHGym.Infrastructure.Data.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("69a5216e-0341-4263-815d-3fd3732c2b7d"),
                            CategoryType = 0,
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 103, DateTimeKind.Utc).AddTicks(2041),
                            IsDeleted = false,
                            Name = "Sports Supplements"
                        },
                        new
                        {
                            Id = new Guid("d2f0802a-d7b2-46f4-a558-a7c717f1d4d0"),
                            CategoryType = 1,
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 103, DateTimeKind.Utc).AddTicks(2045),
                            IsDeleted = false,
                            Name = "Proteins",
                            ParentCategoryId = new Guid("69a5216e-0341-4263-815d-3fd3732c2b7d")
                        });
                });
            ...
            modelBuilder.Entity("GHGHGym.Infrastructure.Data.Models.SubscriptionType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d4c9e3dc-8fb3-4de8-87f4-4b6e7c84f5ba"),
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 102, DateTimeKind.Utc).AddTicks(9896),
                            IsDeleted = false,
                            Name = "Weekly"
                        },
                        new
                        {
                            Id = new Guid("8a85c04d-8d69-40a4-8c02-cbeb5de3e4bb"),
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 102, DateTimeKind.Utc).AddTicks(9937),
                            IsDeleted = false,
                            Name = "Monthly"
                        },
                        new
                        {
                            Id = new Guid("e9a11e16-d9c2-43ed-b803-e7339130b9b9"),
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 102, DateTimeKind.Utc).AddTicks(9938),
                            IsDeleted = false,
                            Name = "Yearly"
                        },
                        new
                        {
                            Id = new Guid("46f0b3dd-5c20-4efc-b22b-ceb799147fda"),
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 102, DateTimeKind.Utc).AddTicks(9939),
                            IsDeleted = false,
                            Name = "Weekly with trainer"
                        },
                        new
                        {
                            Id = new Guid("b139f105-d742-418c-8934-426e54b7bbbe"),
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 102, DateTimeKind.Utc).AddTicks(9940),
                            IsDeleted = false,
                            Name = "Monthly with trainer"
                        },
                        new
                        {
                            Id = new Guid("84d73cc1-7a2f-4097-9c22-c0341890f687"),
                            CreatedOn = new DateTime(2022, 11, 13, 17, 31, 30, 102, DateTimeKind.Utc).AddTicks(9941),
                            IsDeleted = false,
