        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionType = table.Column<int>(type: "int", nullable: false, comment: "Type of the subscription"),
                    Price = table.Column<decimal>(type: "decimal(7,2)", nullable: false, comment: "Price of the subscription"),
            ...
            migrationBuilder.CreateTable(
                name: "TrainerPrograms",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Name of the program"),
                    ProgramDescription = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Description of the training program"),
                    TrainerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Is the entity deleted")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerPrograms", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Primary key"),
                    Text = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "Text of the comment"),
                    PostedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The date on which the comment was posted"),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "The date on which the comment was deleted"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Is the entity deleted from the database"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerPrograms_TrainerId",
